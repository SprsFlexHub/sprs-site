...
<head>
		...
		<title>SPRS - MASTER OF ALL IT Solutions & Services</title>
    ...
    <body>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <ul class="topbar-information">
                            ...
                            <li>
                                ...
                                <span>Mail: <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#a9c1c0cac6d3cce9cec4c8c0c587cac6c4"><span class="__cf_email__" data-cfemail="acc4c5cfc3d6c9eccbc1cdc5c082cfc3c1">[email&#160;protected]</span></a></span>
                            </li>
                            <li>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sidebar-contact-info">
                            ...
                            <ul class="info-list">
                                ...
                                <li><i class="ri-mail-line"></i> <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#d6b5b9acb396b1bbb7bfbaf8b5b9bb"><span class="__cf_email__" data-cfemail="64070b1e01240309050d084a070b09">[email&#160;protected]</span></a></li>
        ...
        <div class="main-hero-area">
            ...
            <div class="hero-shape-1">
                <img src="<?=base_url();?>assets/images/main-hero/slides-shape-1.png" alt="image">
            </div>
            <div class="hero-shape-2">
                <img src="<?=base_url();?>assets/images/main-hero/slides-shape-2.png" alt="image">
            </div>
            <div class="hero-shape-3">
                <img src="<?=base_url();?>assets/images/main-hero/slides-shape-3.png" alt="image">
            </div>
        </div>
        <!-- End Main Hero Area -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-image" data-tilt>
                            <img src="<?=base_url();?>assets/images/about/about-2.png" alt="image" data-aos="fade-down" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-choose-card" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="choose-image" data-tilt>
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/choose/choose-1.png" alt="image"></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-choose-card" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600" data-aos-once="true">
                            <div class="choose-image" data-tilt>
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/choose/choose-2.png" alt="image"></a>
                            </div>
                            <div class="choose-content">
                                <h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-choose-card" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">
                            <div class="choose-image" data-tilt>
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/choose/choose-3.png" alt="image"></a>
                            </div>
                            <div class="choose-content">
                                <h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-choose-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                            <div class="choose-image" data-tilt>
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/choose/choose-4.png" alt="image"></a>
                            </div>
                            <div class="choose-content">
                                <h3>
        ...
        <div class="services-area bg-with-14042C-color ptb-100">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-image">
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-1.jpg" alt="image"></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-image">
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-2.jpg" alt="image"></a>
                            </div>
                            <div class="services-content">
                                <h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-image">
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-3.jpg" alt="image"></a>
                            </div>
                            <div class="services-content">
                                <h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="services-item">
                            <div class="services-image">
                                <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-4.jpg" alt="image"></a>
                            </div>
                            <div class="services-content">
                                <h3>
            ...
            <div class="services-shape-1">
                <img src="<?=base_url();?>assets/images/services/services-shape-1.png" alt="image">
            </div>
            <div class="services-shape-2">
                <img src="<?=base_url();?>assets/images/services/services-shape-2.png" alt="image">
            </div>
        </div>
        <!-- End Services Area -->
        ...
        <div class="projects-area pt-100 pb-75">
            <div class="container">
                ...
                <div id="Container" class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mix mobile development web-design">
                        <div class="single-projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="projects-image">
                                <a href="projects-details.html"><img src="<?=base_url();?>assets/images/projects-two/projects-1.jpg" alt="image"></a>
                            </div>
                        ...
                        <div class="single-projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="projects-image">
                                <a href="projects-details.html"><img src="<?=base_url();?>assets/images/projects-two/projects-2.jpg" alt="image"></a>
                            </div>
                            <div class="projects-content">
                                <h3>
                    ...
                    <div class="col-lg-4 col-md-6 mix development product-design">
                        <div class="single-projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="projects-image">
                                <a href="projects-details.html"><img src="<?=base_url();?>assets/images/projects-two/projects-3.jpg" alt="image"></a>
                            </div>
                            <div class="projects-content">
                                <h3>
                    ...
                    <div class="col-lg-4 col-md-6 mix web-design mobile product-design">
                        <div class="single-projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="projects-image">
                                <a href="projects-details.html"><img src="<?=base_url();?>assets/images/projects-two/projects-4.jpg" alt="image"></a>
                            </div>
                            <div class="projects-content">
                                <h3>
                        ...
                        <div class="single-projects-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="projects-image">
                                <a href="projects-details.html"><img src="<?=base_url();?>assets/images/projects-two/projects-5.jpg" alt="image"></a>
                            </div>
                            <div class="projects-content">
                                <h3>
            ...
            <div class="projects-bg-shape-1">
                <img src="<?=base_url();?>assets/images/projects/projects-bg-shape.png" alt="image">
            </div>
        </div>
        <!-- End Projects Area -->
                ...
                <div class="testimonials-slides owl-carousel owl-theme">
                    <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                        ...
                        <div class="info-item-box">
                            <img src="<?=base_url();?>assets/images/testimonials/testimonials-4.jpg" class="rounded-circle" alt="image">
                    ...
                    <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <p>The professionalism, collaboration and the design they come up with is pheno-menal. Thanks a lot the SPRS Team.</p>

                        <div class="info-item-box">
                            <img src="<?=base_url();?>assets/images/testimonials/testimonials-5.jpg" class="rounded-circle" alt="image">
                    ...
                    <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600" data-aos-once="true">
                        ...
                        <div class="info-item-box">
                            <img src="<?=base_url();?>assets/images/testimonials/testimonials-6.jpg" class="rounded-circle" alt="image">
                    ...
                    <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700" data-aos-once="true">
                        ...
                        <div class="info-item-box">
                            <img src="<?=base_url();?>assets/images/testimonials/testimonials-7.jpg" class="rounded-circle" alt="image">
                    ...
                    <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="90" data-aos-duration="900" data-aos-once="true">
                        ...
                        <div class="info-item-box">
                            <img src="<?=base_url();?>assets/images/testimonials/testimonials-8.jpg" class="rounded-circle" alt="image">
            ...
            <div class="container">
                <div class="partner-slides owl-carousel owl-theme">
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-1.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-1.png" alt="partner">
                        </a>
                    </div>
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-2.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-2.png" alt="partner">
                        </a>
                    </div>
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-3.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-3.png" alt="partner">
                        </a>
                    </div>
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-4.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-4.png" alt="partner">
                        </a>
                    </div>
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-5.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-5.png" alt="partner">
                        </a>
                    </div>
                    <div class="partner-card" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800" data-aos-once="true">
                        <a href="#">
                            <img src="<?=base_url();?>assets/images/partner/partner-6.png" alt="partner">
                            <img src="<?=base_url();?>assets/images/partner/partner-hover-6.png" alt="partner">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="blog-slides owl-carousel owl-theme">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="blog-image">
                                    <a href="single-blog-1.html"><img src="<?=base_url();?>assets/images/blog/blog-1.jpg" alt="image"></a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="blog-card" data-aos="fade-up" data-aos-delay="890" data-aos-duration="900" data-aos-once="true">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="blog-image">
                                    <a href="single-blog-1.html"><img src="<?=base_url();?>assets/images/blog/blog-2.jpg" alt="image"></a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="blog-content">
        ...
        <footer class="footer-area with-black-background margin-zero pt-100">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500" data-aos-once="true">
                            <div class="widget-logo">
                                <a href="index-2.html"><img src="<?=base_url();?>assets/images/logo.png" alt="image"></a>
                            </div>
            ...
            <div class="copyright-area">
                <div class="container">
                    <div class="copyright-area-content">
                        <p>
                            Copyright @<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear())</script> SPRS All Rights Reserved by
            ...
            <div class="footer-shape-1">
                <img src="<?=base_url();?>assets/images/footer/footer-shape-1.png" alt="image">
            </div>
            <div class="footer-shape-2">
                <img src="<?=base_url();?>assets/images/footer/footer-shape-2.png" alt="image">
            </div>
            <div class="footer-shape-3">
                <img src="<?=base_url();?>assets/images/footer/footer-shape-3.png" alt="image">
            </div>
        </footer>
        <!-- End Footer Area -->  
        ...
        <script src="<?=base_url();?>assets/js/animation.gsap.min.js"></script>
        <script src="<?=base_url();?>assets/js/debug.addIndicators.min.js"></script>
