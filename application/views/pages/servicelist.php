...
<div class="choose-area pt-100 pb-75">
    <div class="container">
        <div class="section-title">
            ...
            <p>We are leading technology solutions providing company all over the world doing over 40 years lorem ipsum
                dolor sit amet.</p>
        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-choose-card" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                    ...
                    <div class="choose-content">
                        ...
                        <p>Lorem ipsum dolor sit amet conset sadipscing elitr sed diam nonumy eirm od tempor invidunt ut
                            labore.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="services-slides-two owl-carousel owl-theme">
            <div class="services-item">
                <div class="services-image">
                    <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-1.jpg"
                            alt="image"></a>
                </div>
            ...
            <div class="services-item">
                <div class="services-image">
                    <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-2.jpg"
                            alt="image"></a>
                </div>
                <div class="services-content">
                    <h3>
            ...
            <div class="services-item">
                <div class="services-image">
                    <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-3.jpg"
                            alt="image"></a>
                </div>
                <div class="services-content">
                    <h3>
            ...
            <div class="services-item">
                <div class="services-image">
                    <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-4.jpg"
                            alt="image"></a>
                </div>
                <div class="services-content">
                    <h3>
            ...
            <div class="services-item">
                <div class="services-image">
                    <a href="services-details.html"><img src="<?=base_url();?>assets/images/services/services-5.jpg"
                            alt="image"></a>
                </div>
                <div class="services-content">
                    <h3>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6">
                <div class="overview-card">
                    <h3>Call Us</h3>
                    <span>
                        <a href="tel:919051135603">+91-905-1135-603</a>
                    </span>
